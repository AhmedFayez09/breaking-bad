...
class CharacterDetailsScreen extends StatelessWidget {
  ...
  Widget buildSliverAppBar() {
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        title: Text(
          character.nicname,
          style: const TextStyle(color: MyColors.muWhite),
  ...
  Widget checkIfQoutesAreLouded(CharactersState state) {
    if (state is QuotesLoaded) {
      return displayRandomQuoteOrEmtySpace(state);
    } else {
      return showProgressIndicator();
    }
  }

  Widget displayRandomQuoteOrEmtySpace(state) {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildDivider(300),
                      character.betterCallappearance.isEmpty
                          ? Container()
                          : characterInfo('Better Call Saul Seasons : ',
                              character.betterCallappearance.join(' / ')),
                      character.betterCallappearance.isEmpty
                          ? Container()
                          : buildDivider(315),
                      ...
                      BlocBuilder<CharactersCubit, CharactersState>(
                        builder: (context, state) {
                          return checkIfQoutesAreLouded(state);
                        },
                      ),
                    ],
                  ),
