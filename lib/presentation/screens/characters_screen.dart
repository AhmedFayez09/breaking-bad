...
void addSearchedForItemToSearchedList(String  searchedCharacter){
  ...
  allCharacters.where((Character) => Character.name.toLowerCase().startsWith(searchedCharacter)).toList();
  ...
  void initState() {
    super.initState();
      ...
      BlocProvider.of<CharactersCubit>(context).getAllCharacters();//.cast<Character>()
